...
// 2 Assigner une valeur à la variable 
temps = "pluvieux";

// 3 Vérification de la valeur dans la console
console.log (temps);
...
// Demander à l'utilisateur une valeur (2 facons)
let answer = prompt("Question: On est quel jour aujourd'hui ?");
// window.prompt("Qestion: On est quel jour aujourd'hui ?")
...
// 4. Un booléeon (boolean VRAI/FAUX = TRUE/FALSE)
let condition = false;
